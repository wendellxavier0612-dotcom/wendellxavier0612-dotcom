...
### 🎨 [projeto-inicial-jogo-do-numero-secreto](https://github.com/wendellxavier0612-dotcom/projeto-inicial-jogo-do-numero-secreto)
Estrutura visual (HTML/CSS) que deu origem ao jogo do número secreto — a base antes de adicionar a lógica em JavaScript.
